...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="col-lg-8">
  <form method="post" action="/dashboard/news/{{ $news->id }}" class="mb-5" enctype="multipart/form-data">
    @method('put')
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      is-invalid
      @enderror" id="slug" name="slug" required value="{{ old('slug',$news->slug) }}">
      @error('slug')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
        ...
        @if ($news->image)
            <img src="{{ asset('storage/'.$news->image) }}" class="img-preview img-fluid mb-2 col-sm-5 d-block">
        @else
        <img src="img-preview img-fluid mb-2 col-sm-5 d-block">
        @endif
